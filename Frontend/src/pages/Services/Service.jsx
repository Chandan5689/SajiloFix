...
export default function Service() {
  ...
  // Server-side filtering already applied; no need for redundant client-side filtering
  // Backend handles all search, category, and location filtering intelligently
  // Just use the providers as-is from the backend
